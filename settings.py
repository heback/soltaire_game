...
class SettingsDialog(ft.AlertDialog):
    ...
    def generate_card_backs(self):
        self.card_backs = []
        for i in range(4):
            self.card_backs.append(ft.Container(width=70, height=100, content=ft.Image(src=f"/images/card_back{i}.png"),
                                                border_radius=ft.border_radius.all(6), on_click=self.choose_card_design,
                                                data=i))
